...
export function setHendrixSongs(target) {
    const hendrixSongs = ['Purple Haze', 'All Along the Watchtower', 'Hey Joe'];
    if(Array.isArray(target.prototype.songList)) {
        target.prototype.songList = target.prototype.songList.concat(hendrixSongs);
    } else {
        target.prototype.songList = hendrixSongs;
    }
}